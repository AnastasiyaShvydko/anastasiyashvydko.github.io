...
const hikeList = [
  ...
  export default class Hikes {
    ...
    showOneHike(hikeName) {
        ...
        renderOneHikeLight(this.parentElement, oneHike)
    
    }
    // in order to show the details of a hike ontouchend we will need to attach a listener AFTER the list of hikes has been built. The function below does that.
    addHikeListener() {
      const ourHikes = this.getAllHikes()
      const arrayOfList = Array.from(ourHikes);
      //arrayOfList.forEach(element => console.log(element.name))
      arrayOfList.forEach(hike => {
     ...
     console.log("hover")
     //const thisHike = this.getAllHikes()
     //for (element of arrayOfList)
     //{
       // element.addEventListener('hover', this.showOneHike(element.name))
     //}
